...
type Includes<T extends readonly any[], D> = T['length'] extends 0 ? false : // recursion terminal case
  T extends [infer First, ...infer Rest] ? // recursion decomposition
    Equal<First, D> extends true ? // recursive test
      true : Includes<Rest, D> : never // actual recursion
